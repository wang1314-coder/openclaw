...
function buildCoreDistEntries(): Record<string, string> {
  return {
    ...
    "context-engine-init.runtime": "src/agents/context-engine-init.runtime.ts",
    "context-engine-registry.runtime": "src/agents/context-engine-registry.runtime.ts",
    "runtime-plugins.runtime": "src/agents/runtime-plugins.runtime.ts",
