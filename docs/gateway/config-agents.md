...
- `description`: optional human-authored capability summary. `agents_list` includes it when configured so orchestrators can choose a target agent without hardcoded catalogs.
