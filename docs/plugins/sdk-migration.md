...
<Accordion title="Common import path table">
  ...
  | `plugin-sdk/image-generation` | Image-generation helpers | Image generation provider types plus image asset/data URL helpers, OpenAI-compatible response parsing, and the OpenAI-compatible image provider builder |
