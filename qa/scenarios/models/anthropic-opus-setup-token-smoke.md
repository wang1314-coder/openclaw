...
coverage:
  primary:
    - agent-runtime-and-provider-execution.provider-auth.login-and-api-key-setup
  secondary:
    - anthropic-provider-path.model-and-runtime-selection.canonical-anthropic-refs
