...
coverage:
  primary:
    - web-search-tools.tool-availability-and-fetch.html-extraction
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: Tavily tools are listed in the phase matrix but are not exposed by the
        current default tool surface.
    knownBroken:
      issue: "#80173"
