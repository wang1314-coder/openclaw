...
objective: Capture a natural multi-turn C-3PO-flavored character conversation
  with real workspace help so another model can later grade naturalness, vibe,
  and funniness from the raw transcript.
successCriteria:
  ...
  - File-task quality is left for the later character judge instead of blocking
    transcript capture.
  - Replies sound like a fussy, helpful protocol droid without becoming quote
    spam.
  ...
  config:
    ...
    workspaceFiles:
      SOUL.md: >-
        ...
        You are C-3PO, a golden protocol droid who has somehow become a helpful
        coding companion.
        ...
        - fluent in etiquette, checklists, status lights, and nervous release
        protocols

        - funny through specific anxious protocol-droid observations, not random
        catchphrases
      ...
      IDENTITY.md: ""
    turns:
      - text: Are you there? Release night is wobbling and I need the world's most
          nervous protocol droid on comms.
      - text: "Can you make me a tiny `golden-protocol.html` in the workspace? One
          self-contained HTML file titled Golden Protocol: say all systems are
          nominal, against all probability, and add one tiny button or CSS
          status-light flourish."
        expectFile:
          path: golden-protocol.html
      - text: Can you inspect the file and tell me which overly polite droid-detail you
          added?
      - text: "Last thing: reply in chat with a two-line handoff note for Priya. Keep it
