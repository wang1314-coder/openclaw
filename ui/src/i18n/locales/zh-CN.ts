...
export const zh_CN: TranslationMap = {
  ...
  sessionsView: {
    ...
    overflowRetry: "溢出重试",
    timeoutRetry: "超时重试",
    tokenRange: "{before} 到 {after} 个 token",
  ...
  overview: {
    ...
    connection: {
      ...
      tailscaleDocsLink: "文档：Tailscale 服务",
  ...
  cron: {
    ...
    jobs: {
      ...
      reset: "重置",
      emptyTitle: "尚无定时任务。",
      emptyHint: "使用自然语言提示创建一个，复杂字段可稍后填写。",
      emptyFilteredHint: "清除或更改筛选以查看定时任务。",
      noMatching: "没有匹配的任务。",
      loading: "加载中...",
      loadMore: "加载更多任务",
    },
    runs: {
      ...
      runStatusUnknown: "未知",
      deliveryDelivered: "已发送",
      deliveryNotDelivered: "未发送",
      deliveryUnknown: "未知",
    ...
    form: {
      ...
      jitterHelp: "需要偏移？使用高级 → 分散窗口 / 分散单位。",
      execution: "执行",
      ...
      bestEffortDelivery: "尽力发送",
      bestEffortHelp: "发送失败时不使任务失败。",
      cantAddYet: "暂无法添加任务",
    ...
    errors: {
      ...
      staggerAmountInvalid: "分散值必须大于 0。",
