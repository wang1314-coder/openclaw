...
export const uk: TranslationMap = {
  ...
  chat: {
    ...
    selectors: {
      ...
      renameFailed: "Failed to rename session: {error}",
      renameRefreshFailed: "Session renamed, but refresh failed: {error}",
      renamePickerRefreshFailed: "Session renamed, but picker refresh failed: {error}",
      model: "Chat model",
