  ...
  try {
    ...
    const hookResult = await runBeforeToolCallHook({
      ...
      ctx: {
        ...
        config: params.cfg,
        sessionKey,
        ...(params.messageChannel ? { turnSourceChannel: params.messageChannel } : {}),
        ...(params.agentTo ? { turnSourceTo: params.agentTo } : {}),
        ...(params.accountId ? { turnSourceAccountId: params.accountId } : {}),
        ...(params.agentThreadId ? { turnSourceThreadId: params.agentThreadId } : {}),
