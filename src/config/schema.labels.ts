...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.memoryPressureThresholds.rssWarningBytes": "RSS Warning Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.rssCriticalBytes": "RSS Critical Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.heapUsedWarningBytes": "Heap Used Warning Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.heapUsedCriticalBytes": "Heap Used Critical Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.rssGrowthWarningBytes": "RSS Growth Warning Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.rssGrowthCriticalBytes": "RSS Growth Critical Threshold (bytes)",
  "diagnostics.memoryPressureThresholds.growthWindowMs": "Memory Growth Window (ms)",
  "diagnostics.memoryPressureThresholds.pressureRepeatMs": "Memory Pressure Repeat Interval (ms)",
