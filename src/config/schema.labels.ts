...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.fs.workspaceAliases": "Workspace FS aliases",
  "tools.fs.workspaceAliases[].path": "Workspace alias path",
  "tools.fs.workspaceAliases[].target": "Workspace alias target",
