...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.memoryGuard": "Tool Memory Guard",
  "tools.memoryGuard.enabled": "Enable Tool Memory Guard",
  "tools.memoryGuard.minAvailableBytes": "Tool Memory Minimum Available Bytes",
  "tools.memoryGuard.minAvailablePercent": "Tool Memory Minimum Available Percent",
