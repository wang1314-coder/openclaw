...
export const FIELD_LABELS: Record<string, string> = {
  ...
  agents: "Agents",
  "agents.executionBackends": "Agent Execution Backends",
  "agents.executionBackends.*.type": "Agent Execution Backend Type",
  "agents.executionBackends.*.profiles": "Agent Execution Backend Profiles",
