...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "runtimeContext.source": "Runtime Context Source",
  "runtimeContext.expose": "Runtime Context Exposure",
  "runtimeContext.expose.mode": "Runtime Context Exposure Mode",
  "runtimeContext.ttlSeconds": "Runtime Context TTL (sec)",
  "runtimeContext.validUntil": "Runtime Context Valid Until",
  "runtimeContext.value": "Runtime Self Context",
  tools: "Tools",
