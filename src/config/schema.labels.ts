...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "acp.delegate": "ACP Hub-Delegated Sessions",
  "acp.delegate.idleHours": "ACP Hub-Delegated Idle Timeout (hours)",
  "acp.delegate.maxAgeHours": "ACP Hub-Delegated Max Age (hours)",
  models: "Models",
