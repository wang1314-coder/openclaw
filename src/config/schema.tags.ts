...
const TAG_OVERRIDES: Record<string, ConfigTag[]> = {
  ...
  "agents.executionBackends": ["tools", "performance", "reliability"],
  "agents.executionBackends.*.type": ["tools", "reliability"],
  "agents.executionBackends.*.profiles": ["tools", "performance"],
